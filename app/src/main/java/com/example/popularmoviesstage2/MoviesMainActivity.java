...
public class MoviesMainActivity extends AppCompatActivity implements PopularMoviesAdapter.ItemClickListener {
    ...
    public void onItemClick(View view, int position) {
        ...
        launchMovieDetailsActivity(movieTitle, posterPath, release_date, vote_average, overview, id);


    }

    private void launchMovieDetailsActivity(String movieTitle, String posterPath, String release_date, String vote_average, String overview, String id) {
        ...
        intent.putExtra(MovieDetailsActivity.EXTRA_ID, id);
